...
const {getInformation}=require('../../util/dbhelper')
...
//user_id, user_type, ammount, roi, nominee_id, account_no, payment_id, agreement_file, status, withdrw_req_time, is_send
  //initilized the object here from request body:

 


  response.json(getInformation(data));
